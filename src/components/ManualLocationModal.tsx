...
export const ManualLocationModal = ({
    ...
    const handlePaste = (e: React.ClipboardEvent) => {
        ...
        // Check if the pasted string contains a comma (common for Google Maps)
            ...
            <div className="w-full max-w-sm bg-slate-900 border border-slate-800 rounded-3xl p-6 shadow-2xl animate-in zoom-in-95 duration-300">
                <div className="flex justify-between items-start mb-6">
                    <div>
                        ...
                        <p className="text-slate-400 text-xs mt-1">Enter your current coordinates</p>
                    </div>
                    <button 
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-mono text-slate-500 uppercase tracking-widest ml-1">Latitude</label>
                        <input
                            type="text"
                            inputMode="decimal"
                            value={lat}
                    ...
                    <div className="space-y-1.5">
                        <label className="text-[10px] font-mono text-slate-500 uppercase tracking-widest ml-1">Longitude</label>
                        <input
                            type="text"
                            inputMode="decimal"
                            value={lon}
                ...
                <div className="mt-6 pt-6 border-t border-slate-800/50">
                    <p className="text-[10px] text-slate-500 text-center leading-relaxed italic">
                        Tip: You can paste the "lat, lon" string directly from Google Maps into either field!
                    </p>
                </div>
            </div>
        </div>
